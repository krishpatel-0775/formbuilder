    ...
    <div className="space-y-4">
      ...
      {activeField.type === "toggle" && (
        <div 
          ...
          className={`flex items-center justify-between p-4 rounded-2xl cursor-pointer border transition-all duration-500 ${
        ...
        >
          ...
          <div className={`w-10 h-5 rounded-full transition-all relative ${
              activeField.defaultValue === "true" ? "bg-emerald-500 shadow-lg shadow-emerald-500/30" : "bg-slate-200"
          }`}>
            <div className={`absolute top-1 w-3 h-3 bg-white rounded-full transition-all duration-300 ${
                activeField.defaultValue === "true" ? "translate-x-6 scale-110" : "translate-x-1"
            }`} />
          </div>
        </div>
      )}
        ...
        >
          <div className="flex items-center gap-3">
              <div className={`w-10 h-10 rounded-2xl flex items-center justify-center transition-all ${
                  activeField.required ? "bg-primary text-white" : "bg-white text-slate-300 border border-slate-100"
              }`}>
