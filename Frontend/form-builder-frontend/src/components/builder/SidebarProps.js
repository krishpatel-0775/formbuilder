  ...
  return (
    <div className="space-y-10 pb-10">
      ...
      <div className="space-y-4">
        ...
        >
          <div className="flex items-center gap-3">
            <div className={`w-10 h-10 rounded-2xl flex items-center justify-center transition-all ${activeField.isReadOnly ? "bg-amber-500 text-white" : "bg-white text-slate-300 border border-slate-100"
              }`}>
