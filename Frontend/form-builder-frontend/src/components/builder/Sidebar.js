      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar pb-32">
        ...
        <div className="p-8 pb-4 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-4">
            <div className={`w-12 h-12 flex items-center justify-center rounded-2xl border transition-all duration-500 shadow-inner ${sidebarTab === "logic" ? "bg-primary text-white border-primary shadow-primary/20" : "bg-slate-50 text-slate-400 border-slate-100"
              }`}>
        ...
        <div className="px-8 py-4 flex-shrink-0">
          <div className="flex gap-1.5 bg-slate-100/80 p-1.5 rounded-2xl">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-[1.25rem] text-[11px] font-black uppercase tracking-widest transition-all ${sidebarTab === "properties"
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-[1.25rem] text-[11px] font-black uppercase tracking-widest transition-all relative ${sidebarTab === "logic"
            ...
            >
              ...
              {(() => {
                ...
                return count > 0 ? (
                  <span className={`ml-2 text-[10px] font-black px-2 py-0.5 rounded-full ${sidebarTab === "logic" ? "bg-white text-primary" : "bg-primary text-white"
                    }`}>{count}</span>
                ) : null;
              })()}
            </button>
